...
namespace BakeryAuth.Migrations
{
    ...
    [Migration("20210115192937_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BakeryAuth.Models.FlavorTreat", b =>
                {
            ...
            modelBuilder.Entity("BakeryAuth.Models.Flavor", b =>
                {
                    b.HasOne("BakeryAuth.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("BakeryAuth.Models.FlavorTreat", b =>
                {
                    b.HasOne("BakeryAuth.Models.Flavor", "Flavor")
                        .WithMany("Treats")
                        .HasForeignKey("FlavorId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BakeryAuth.Models.Treat", "Treat")
                        .WithMany("Flavors")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BakeryAuth.Models.ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
